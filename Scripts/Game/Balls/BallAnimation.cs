...
public static class BallAnimation
{
    public static void GetNewBallAnimation(BallObject ball, float scale, float duration) => ball.transform.DOScale(scale, duration);

    public static void HideBall(BallObject ball, float duration) => ball.transform.DOScale(new Vector3(0f, 0f, 0f), duration);
